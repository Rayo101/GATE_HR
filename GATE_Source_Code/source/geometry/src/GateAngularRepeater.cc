...
GateAngularRepeater::GateAngularRepeater(GateVVolume* itsObjectInserter,
                                         ...
                                         G4double itsZShift7,
                                         G4double itsZShift8,
                                         G4int    itsExcludeBlock1,
                                         G4int    itsExcludeBlock2,
                                         G4int    itsExcludeBlock3,
                                         G4int    itsExcludeBlock4)
: GateVGlobalPlacement(itsObjectInserter,itsName),
  ...
  m_excludeBlock1(itsExcludeBlock1),
  m_excludeBlock2(itsExcludeBlock2),
  m_excludeBlock3(itsExcludeBlock3),
  m_excludeBlock4(itsExcludeBlock4),
  m_Messenger(0)
{
                                           ...
                                           G4double )
{
  ...
  {
    if (i == m_excludeBlock1 || i == m_excludeBlock2 || i == m_excludeBlock3 || i == m_excludeBlock4)
    {
      i++;
    }
    else
...
void GateAngularRepeater::DescribeMyself(size_t indent)
{
  ...
  G4cout << GateTools::Indent(indent) << "Exclude Block:        " << m_excludeBlock1 << "\n";
  G4cout << GateTools::Indent(indent) << "Exclude Block:        " << m_excludeBlock2 << "\n";
  G4cout << GateTools::Indent(indent) << "Exclude Block:        " << m_excludeBlock3 << "\n";
  G4cout << GateTools::Indent(indent) << "Exclude Block:        " << m_excludeBlock4 << "\n";
}
//-----------------------------------------------------------------------------------------------
