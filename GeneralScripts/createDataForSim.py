...
def main():
    ...
    INPATH = "/home/rayhaan/randomWalk_V3/GATE_Generation/SS_0.60_TS_0.80_means_1.0_100.0_mm_5000_locs_300um/NPY_Placements/Mean_0.001_ms/etc.npy"
    ...
    writeData(data = pathData, OUTPATH = OUTPATH, OUTNAME = OUTNAME + ".placements")
